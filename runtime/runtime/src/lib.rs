...
impl Runtime {
    ...
    fn apply_action(
        ...
        let is_refund = receipt.predecessor_id.as_ref() == "system";
        // Account validation
    ...
    fn apply_action_receipt(
        ...
        let gas_deficit_amount = if receipt.predecessor_id.as_ref() == "system" {
        ...
        let gas_burnt: Gas =
            if receipt.predecessor_id.as_ref() == "system" { 0 } else { result.gas_burnt };
